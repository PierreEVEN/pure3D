...
MAKE_HASHABLE(SVector4, t.x, t.y, t.z, t.w);
MAKE_HASHABLE(SVector4Double, t.x, t.y, t.z, t.w);
MAKE_HASHABLE(SIntVector4, t.x, t.y, t.z, t.w);
MAKE_HASHABLE(SLongVector4, t.x, t.y, t.z, t.w);
